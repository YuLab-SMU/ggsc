...
plot the spatial distribution of cell type.
```{r sce-cell-spatial, fig.width = 14, fig.height = 10}
sc_spatial(spe, mapping=aes(x=pxl_col_in_fullres,y=pxl_row_in_fullres,color = label))
```